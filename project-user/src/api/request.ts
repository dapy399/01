// 根据环境变量获取API地址
const requestUrl = import.meta.env.VITE_API_BASE_URL || "http://127.0.0.1:7005/api";
...
export const SendMessageApi = async (params: SendMessageType) => {
  const { content, sessionId, uploadFileList, isKnowledgeBased, isWebSearch, uploadImageList } = params;
